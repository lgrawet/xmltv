...
RUN cpan install Archive::Zip DateTime DateTime::Format::Strptime File::Slurp HTML::TreeBuilder HTTP::Cache::Transparent IO::Scalar JSON Lingua::EN::Numbers::Ordinate Lingua::Preferred Term::ProgressBar Term::ReadKey XML::Twig Date::Manip Tk Tk::TableMatrix Unicode::String Unicode::UTF8simple XML::DOM XML::LibXML XML::LibXSLT XML::TreePP XML::Writer  && rm -rf /root/.cpan
